...
class AverageSTESNLP:
    def __init__(self, averagesystem: AveragedStratStorageModel, data: Data, N =365 * 24):

        self.system = averagesystem
        ...
        for m in range(M):
            ...
            p_data_vals = data.getDataAtTimes(t_m, t_mp1, h) # ambient temperature and heat demand
            ...
            Qdot_hp_aver = 1/ratio*sum([averagesystem.compute_Qdot_hp(P_hp * p_fix[1],T_amb) for P_hp,T_amb in zip(u_vals, p_data_vals[0])])
