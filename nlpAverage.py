...
class AverageSTESNLP(STESNLP):
    ...
    def build_NLP(self):
        ...
        # w0['U', :, 0] = ca.horzsplit((p_data_n[1, :] * 2  - p_data_n[3, :]) / 3)  # P_pv + P_wind - P_load
        # w0['U', :, 1] = ca.horzsplit((p_data_n[1, :] * 2  - p_data_n[3, :]) / 3)
        # w0['U', :, 2] = ca.horzsplit((p_data_n[3, :] - p_data_n[1, :] *2 ) / 3)  # P_load - P_pv - P_wind
